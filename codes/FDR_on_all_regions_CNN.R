...
directory <- "/projects/apog/work/models/1MB/Luekemia/Test_on_ISP_CNN_corrected_scale_SEX_cov/T_Test_all"
...
full_output_file <- "/projects/apog/work/models/1MB/Luekemia/Test_on_ISP_CNN_corrected_scale_SEX_cov/FDR_all_on_all_regions_Luekemia_Corrected_scaled_CNN_gens_byDSEQ_COV_SEX_no_filtering_before_FDR.txt"
# full_output_file <- "/projects/apog/work/models/1MB/Luekemia/Test_on_ISP_CNN_corrected_scale_SEX_cov/FDR_all_on_all_regions_Luekemia_Corrected_scaled_CNN_gens_byDSEQ_COV_SEX_no_filtering_before_FDR.txt"
...
filtered_output_file <- "/projects/apog/work/models/1MB/Luekemia/Test_on_ISP_CNN_corrected_scale_SEX_cov/sig_unique_regions_after_FDR_smaller_0.05_Luekemia_Corrected_scale_CNN_gens_byDSEQ_COV_SEX_no_filtering_before_FDR.txt"
# 
# filtered_data$names <- sapply(filtered_data$names, transform_values)
write_tsv(filtered_data, filtered_output_file)

filtered_output_file2 <- "/projects/apog/work/models/1MB/Luekemia/Test_on_ISP_CNN_corrected_scale_SEX_cov/JUST_sig_unique_regions_after_FDR_smaller_0.05_Luekemia_Corrected_Scaled_CNN_gens_byDSEQ_COV_SEX_no_filtering_before_FDR.txt"
